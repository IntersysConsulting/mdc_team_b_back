...
update_admin.add_argument('id',
                          ...
                          required=True,
                          location='form')
update_admin.add_argument('current_password',
                          help='Current password of admin',
                          required=True,
                          location='form')
update_admin.add_argument('first_name',
                          help='First name of the admin',
                          required=True,
                          location='form')
update_admin.add_argument('last_name',
                          help='Last name of the admin',
                          required=True,
                          location='form')
update_admin.add_argument('new_password',
